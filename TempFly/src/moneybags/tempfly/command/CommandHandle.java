package moneybags.tempfly.command;
...
import moneybags.tempfly.command.admin.CmdGive;
import moneybags.tempfly.command.admin.CmdGiveAll;
import moneybags.tempfly.command.admin.CmdReload;
import moneybags.tempfly.command.admin.CmdRemove;
import moneybags.tempfly.command.admin.CmdSet;
import moneybags.tempfly.command.admin.CmdTrailRemove;
import moneybags.tempfly.command.player.CmdFly;
import moneybags.tempfly.command.player.CmdHelp;
import moneybags.tempfly.command.player.CmdIslandSettings;
import moneybags.tempfly.command.player.CmdPay;
import moneybags.tempfly.command.player.CmdShop;
import moneybags.tempfly.command.player.CmdSpeed;
import moneybags.tempfly.command.player.CmdTime;
import moneybags.tempfly.command.player.CmdTrails;
